...
## to run these commands in your console, put the cursor on one line of code 
## and type ctrl+enter (cmd+enter on a mac)

## install the required packages
## you can also do this "point and click" style on the lower-right panel under 
...
## set your working directory here. This is the folder on your computer where 
## you have downloaded the pines.txt file 
## This is how you tell R where to look for files 
...
setwd("~/Documents/EBIO4270-5270_PopGen/Labs/06_basic_R_stats/") 


## this command reads in the data and tells R that you have a header row ("header=TRUE") 
...
## Ok- now let's plot Hs (the average heterozygosity of subdivided pops) against 
## Ht (the pooled heterozygosity)
## remember, we discussed these in lecture!
## you'll see that these values are columns in the basicstat$perloc slot- we can 
## just plot those columns against each other

## plot Hs against Ht
## you'll see that we can use the $ operator to specify exactly which data in our 
## object we want to plot
## we're telling R to go to our basicstat object, go to the perloc slot, and then 
## pull out the information on Hs and Ht and plot them against each other
