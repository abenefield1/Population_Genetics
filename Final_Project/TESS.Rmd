...
Read in the data
```{r TWO}
dataset1<-read.csv("data_genind.csv") # Previously wrote data_genind.csv from a genind@tab slot
dim(dataset1)
head(dataset1)[1:10] # 69 individuals: 9966 SNPs
coords1<-read.csv("Dataset3.meta.csv", sep=",")
head(coords1)
coords1<-coords1[,c(-2,-3)] # Remove Sample and population column
...
```
We have 69 individuals and 9966 SNPs. Rows are individuals, columns are SNPs.
